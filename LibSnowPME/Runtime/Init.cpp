...
namespace SnowPME::Runtime {
	...
	void Init::addFunctions() {
		...
		mono_add_internal_call("Sce.PlayStation.Core.Graphics.PsmShaderProgram::SetUniformValue(int,int,int,Sce.PlayStation.Core.Matrix4&,Sce.PlayStation.Core.Graphics.ShaderUniformType)", Sce::PlayStation::Core::Graphics::PsmShaderProgram::SetUniformValue);
		mono_add_internal_call("Sce.PlayStation.Core.Graphics.PsmShaderProgram::SetUniformValue(int,int,int,Sce.PlayStation.Core.Vector4&,Sce.PlayStation.Core.Graphics.ShaderUniformType)", Sce::PlayStation::Core::Graphics::PsmShaderProgram::SetUniformValue);
		mono_add_internal_call("Sce.PlayStation.Core.Graphics.PsmShaderProgram::SetUniformValue(int,int,int,Sce.PlayStation.Core.Vector3&,Sce.PlayStation.Core.Graphics.ShaderUniformType)", Sce::PlayStation::Core::Graphics::PsmShaderProgram::SetUniformValue);
		mono_add_internal_call("Sce.PlayStation.Core.Graphics.PsmShaderProgram::SetUniformValue(int,int,int,Sce.PlayStation.Core.Vector2&,Sce.PlayStation.Core.Graphics.ShaderUniformType)", Sce::PlayStation::Core::Graphics::PsmShaderProgram::SetUniformValue);
		mono_add_internal_call("Sce.PlayStation.Core.Graphics.PsmShaderProgram::SetUniformValue(int,int,int,single&,Sce.PlayStation.Core.Graphics.ShaderUniformType)", Sce::PlayStation::Core::Graphics::PsmShaderProgram::SetUniformValue);
		mono_add_internal_call("Sce.PlayStation.Core.Graphics.PsmShaderProgram::SetUniformValue(int,int,int,int&,Sce.PlayStation.Core.Graphics.ShaderUniformType)", Sce::PlayStation::Core::Graphics::PsmShaderProgram::SetUniformValue);
		mono_add_internal_call("Sce.PlayStation.Core.Graphics.PsmShaderProgram::SetUniformValue2(int,int,Sce.PlayStation.Core.Matrix4[],Sce.PlayStation.Core.Graphics.ShaderUniformType,int,int,int)", Sce::PlayStation::Core::Graphics::PsmShaderProgram::SetUniformValue2);
		mono_add_internal_call("Sce.PlayStation.Core.Graphics.PsmShaderProgram::SetUniformValue2(int,int,Sce.PlayStation.Core.Vector4[],Sce.PlayStation.Core.Graphics.ShaderUniformType,int,int,int)", Sce::PlayStation::Core::Graphics::PsmShaderProgram::SetUniformValue2);
		mono_add_internal_call("Sce.PlayStation.Core.Graphics.PsmShaderProgram::SetUniformValue2(int,int,Sce.PlayStation.Core.Vector3[],Sce.PlayStation.Core.Graphics.ShaderUniformType,int,int,int)", Sce::PlayStation::Core::Graphics::PsmShaderProgram::SetUniformValue2);
		mono_add_internal_call("Sce.PlayStation.Core.Graphics.PsmShaderProgram::SetUniformValue2(int,int,Sce.PlayStation.Core.Vector2[],Sce.PlayStation.Core.Graphics.ShaderUniformType,int,int,int)", Sce::PlayStation::Core::Graphics::PsmShaderProgram::SetUniformValue2);
		mono_add_internal_call("Sce.PlayStation.Core.Graphics.PsmShaderProgram::SetUniformValue2(int,int,single[],Sce.PlayStation.Core.Graphics.ShaderUniformType,int,int,int)", Sce::PlayStation::Core::Graphics::PsmShaderProgram::SetUniformValue2);
		mono_add_internal_call("Sce.PlayStation.Core.Graphics.PsmShaderProgram::SetUniformValue2(int,int,int[],Sce.PlayStation.Core.Graphics.ShaderUniformType,int,int,int)", Sce::PlayStation::Core::Graphics::PsmShaderProgram::SetUniformValue2);
