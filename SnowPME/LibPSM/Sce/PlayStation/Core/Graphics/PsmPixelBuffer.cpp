...
namespace Sce::PlayStation::Core::Graphics {
	int PsmPixelBuffer::Create(PixelBufferType type, int width, int height, bool mipmap, PixelFormat format, PixelBufferOption option, InternalOption option2, int* result) {
		std::cout << "Sce::PlayStation::Core::Graphics::Create(Sce::PlayStation::Core::Graphics::PixelBufferType, int, int, bool, Sce::PlayStation::Core::Graphics::PixelFormat, Sce::PlayStation::Core::Graphics::PixelBufferOption, Sce::PlayStation::Core::Graphics::InternalOption, int *) Unimplemented." << std::endl;
		return 0;
	}
	...
	int PsmPixelBuffer::GetInfo(int handle, PixelBufferType* type, int* width, int* height, int* level, PixelFormat* format, PixelBufferOption* option){
		std::cout << "Sce::PlayStation::Core::Graphics::GetInfo(int, Sce::PlayStation::Core::Graphics::PixelBufferType *, int *, int *, int *, Sce::PlayStation::Core::Graphics::PixelFormat *, Sce::PlayStation::Core::Graphics::PixelBufferOption *) Unimplemented." << std::endl;
		return 0;
	}
}
