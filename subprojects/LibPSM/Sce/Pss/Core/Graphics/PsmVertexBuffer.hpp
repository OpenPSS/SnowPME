...
namespace Sce::Pss::Core::Graphics {
	...
	public:
		...
		static int SetVertices(int handle, MonoArray *vertices, int to, int from, int count);
		...
		static int SetIndices(int handle, MonoArray* indices, int to, int from, int count);
	};
}
#endif
