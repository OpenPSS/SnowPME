...
namespace Sce::Pss::Core::Mono {
	...
	void Init::addFunctions() {
		...
		add_call("Sce.PlayStation.Core.Environment.TextInputDialog::NewNative(Sce.PlayStation.Core.Environment.CommonDialogType,int&)", Sce::Pss::Core::Environment::TextInputDialog::NewNative);
		add_call("Sce.PlayStation.Core.Environment.TextInputDialog::ReleaseNative(Sce.PlayStation.Core.Environment.CommonDialogType,int)", Sce::Pss::Core::Environment::TextInputDialog::ReleaseNative);
		add_call("Sce.PlayStation.Core.Environment.TextInputDialog::OpenNative(Sce.PlayStation.Core.Environment.CommonDialogType,int,Sce.PlayStation.Core.Environment.TextInputDialog/Arguments&)", Sce::Pss::Core::Environment::TextInputDialog::OpenNative);
		add_call("Sce.PlayStation.Core.Environment.TextInputDialog::AbortNative(Sce.PlayStation.Core.Environment.CommonDialogType,int)", Sce::Pss::Core::Environment::TextInputDialog::AbortNative);
		add_call("Sce.PlayStation.Core.Environment.TextInputDialog::GetState(Sce.PlayStation.Core.Environment.CommonDialogType,int,Sce.PlayStation.Core.Environment.CommonDialogState&)", Sce::Pss::Core::Environment::TextInputDialog::GetState);
		add_call("Sce.PlayStation.Core.Environment.TextInputDialog::GetResult(Sce.PlayStation.Core.Environment.CommonDialogType,int,Sce.PlayStation.Core.Environment.CommonDialogResult&,Sce.PlayStation.Core.Environment.TextInputDialog/Results&)", Sce::Pss::Core::Environment::TextInputDialog::GetResult);
		...
		add_call("Sce.PlayStation.Core.Services.InAppPurchaseDialog::NewNative(int,int&)", Sce::Pss::Core::Services::InAppPurchaseDialog::NewNative);
		add_call("Sce.PlayStation.Core.Services.InAppPurchaseDialog::ReleaseNative(int,int)", Sce::Pss::Core::Services::InAppPurchaseDialog::ReleaseNative);
		add_call("Sce.PlayStation.Core.Services.InAppPurchaseDialog::OpenNative(int,int,Sce.PlayStation.Core.Services.InAppPurchaseDialog/CommandArguments&)", Sce::Pss::Core::Services::InAppPurchaseDialog::OpenNative);
		add_call("Sce.PlayStation.Core.Services.InAppPurchaseDialog::AbortNative(int,int)", Sce::Pss::Core::Services::InAppPurchaseDialog::AbortNative);
		add_call("Sce.PlayStation.Core.Services.InAppPurchaseDialog::GetState(int,int,Sce.PlayStation.Core.Environment.CommonDialogState&)", Sce::Pss::Core::Services::InAppPurchaseDialog::GetState);
		add_call("Sce.PlayStation.Core.Services.InAppPurchaseDialog::GetResult(int,int,Sce.PlayStation.Core.Environment.CommonDialogResult&,Sce.PlayStation.Core.Services.InAppPurchaseDialog/CommandResults&)", Sce::Pss::Core::Services::InAppPurchaseDialog::GetResult);
		...
		add_call("Sce.PlayStation.Core.Device.CameraImportDialog::NewNative(int,int&)", Sce::Pss::Core::Device::CameraImportDialog::NewNative);
		add_call("Sce.PlayStation.Core.Device.CameraImportDialog::ReleaseNative(int,int)", Sce::Pss::Core::Device::CameraImportDialog::ReleaseNative);
		add_call("Sce.PlayStation.Core.Device.CameraImportDialog::OpenNative(int,int,Sce.PlayStation.Core.Device.CameraImportDialog/DialogArguments&)", Sce::Pss::Core::Device::CameraImportDialog::OpenNative);
		add_call("Sce.PlayStation.Core.Device.CameraImportDialog::AbortNative(int,int)", Sce::Pss::Core::Device::CameraImportDialog::AbortNative);
		add_call("Sce.PlayStation.Core.Device.CameraImportDialog::GetState(int,int,Sce.PlayStation.Core.Environment.CommonDialogState&)", Sce::Pss::Core::Device::CameraImportDialog::GetState);
		add_call("Sce.PlayStation.Core.Device.CameraImportDialog::GetResult(int,int,Sce.PlayStation.Core.Environment.CommonDialogResult&,Sce.PlayStation.Core.Device.CameraImportDialog/DialogResults&)", Sce::Pss::Core::Device::CameraImportDialog::GetResult);
		add_call("Sce.PlayStation.Core.Device.PhotoImportDialog::NewNative(int,int&)", Sce::Pss::Core::Device::PhotoImportDialog::NewNative);
		add_call("Sce.PlayStation.Core.Device.PhotoImportDialog::ReleaseNative(int,int)", Sce::Pss::Core::Device::PhotoImportDialog::ReleaseNative);
		add_call("Sce.PlayStation.Core.Device.PhotoImportDialog::OpenNative(int,int,Sce.PlayStation.Core.Device.PhotoImportDialog/DialogArguments&)", Sce::Pss::Core::Device::PhotoImportDialog::OpenNative);
		add_call("Sce.PlayStation.Core.Device.PhotoImportDialog::AbortNative(int,int)", Sce::Pss::Core::Device::PhotoImportDialog::AbortNative);
		add_call("Sce.PlayStation.Core.Device.PhotoImportDialog::GetState(int,int,Sce.PlayStation.Core.Environment.CommonDialogState&)", Sce::Pss::Core::Device::PhotoImportDialog::GetState);
		add_call("Sce.PlayStation.Core.Device.PhotoImportDialog::GetResult(int,int,Sce.PlayStation.Core.Environment.CommonDialogResult&,Sce.PlayStation.Core.Device.PhotoImportDialog/DialogResults&)", Sce::Pss::Core::Device::PhotoImportDialog::GetResult);
