...
namespace Sce::PlayStation::Core::Imaging {
	...
	public:
		...
		static int NewFromModeSizeBuffer(ImageMode mode, ImageSize *size, std::byte *buffer, int *handle);
		...
		static int GetPixelData(int handle, std::byte *buffer, uint32_t bufferSize);
